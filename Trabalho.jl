...
# ╔═╡ 87e600c2-5108-11ec-03fc-4303683d33d2
md"""
# Quantitative Finance
**Team**: Davi Barreira, Gabriel Doc, Pedro Dall
"""

# ╔═╡ 5a6a2ef7-f305-4c0e-af31-2e59fe728185
md"""
...
md"""
### Computing Constants
Next, let's compute the constants we found when solving our optimization problem.
These are
```math
\gamma = \sqrt{\frac{\phi}{k}}, \quad \quad \quad
\zeta = \frac{\alpha -b/2 + \sqrt{k \phi}}{\alpha -b/2 - \sqrt{k \phi}}, \quad \quad
\chi(t) = \sqrt{k \phi} \frac{1+\zeta e^{2\gamma(T-t)}}{1-\zeta e^{2\gamma(T-t)}},
```

```math
\nu_{t}^{*}=-\frac{1}{k} \chi(t) Q_{t}^{\nu^{*}}-\frac{b}{2 k} \ell(t) \mu_{t},
```
```math
...
function plotsamplesimulation(S, Q, ν, μ, t)
	f = Figure()
